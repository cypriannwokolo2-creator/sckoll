...
const SIGNALS = [
  ...
  { value: "0.82+", label: "match threshold" },
  { value: "3.4k", label: "signals today" },
  { value: "$0", label: "to start" },
];

const OPPORTUNITIES = [
  { type: "PROJECT", title: "React Native product sprint", company: "Northstar Labs", score: "96%", skills: "3 shared skills" },
  { type: "CONTRACT", title: "Design system migration", company: "Meridian Health", score: "91%", skills: "5 shared skills" },
  { type: "ROLE", title: "Frontend engineer — remote", company: "Openlane", score: "87%", skills: "4 shared skills" },
];

const MODULES = [
  { title: "Opportunity Radar", description: "Live jobs, gigs, and client demand gathered from across the web.", tag: "DISCOVER" },
  { title: "Neural Matching", description: "A fit score built from your proof of work, skills, seniority, and intent.", tag: "UNDERSTAND" },
  { title: "Proposal Agent", description: "A strong, specific pitch drafted in your voice and ready for your approval.", tag: "EXECUTE" },
];

const TRUST_POINTS = [
  "Verified profiles and professional graph linking",
  "Scam detection across opportunities and conversations",
  "Milestone-safe payments with a complete audit trail",
];
      ...
      <main>
          ...
          <div className="relative mx-auto flex max-w-7xl flex-col items-start gap-8 px-4 pb-24 pt-56 md:px-0 md:pt-48">
            ...
            <div className="w-full max-w-3xl">
              <div className="flex flex-wrap items-center gap-6">
                ...
                <span className="text-left leading-tight"><span className="block font-wordmark text-2xl font-bold uppercase tracking-wide text-white">Signal to signed</span><span className="hidden font-wordmark text-2xl tracking-wide text-neutral-400 sm:block">Work, one flow</span></span>
              </div>
              <div className="mt-10 flex max-w-2xl flex-wrap items-center justify-between gap-4 border-y border-white/15 py-8 md:mt-16 md:flex-col md:items-start md:gap-6" id="start">
                <div className="flex items-center gap-4">
                  ...
                  <span className="hidden text-left leading-tight sm:block"><span className="block font-wordmark text-base font-bold tracking-wide text-white">AI-scored opportunities, pitches &amp; contracts</span><span className="block font-wordmark text-base tracking-wide text-neutral-400">find the fit, send the work, get paid</span></span>
                </div>
        ...
        <section className="mx-auto max-w-6xl px-6 py-16" id="signals">
          <div className="flex flex-wrap items-end justify-between gap-4">
            <div>
              ...
              <h2 className="mt-2 font-maven text-3xl font-semibold tracking-tight">The best-fit work, right now.</h2>
            </div>
        ...
        <section className="border-y bg-white" id="engine">
          <div className="mx-auto max-w-6xl px-6 py-16">
            <div className="mb-8"><p className="text-sm uppercase tracking-widest text-[#5b6470]">The engine</p><h2 className="mt-2 font-maven text-3xl font-semibold tracking-tight">From signal to signed work.</h2></div>
        ...
        <section className="border-b bg-[#f1f6e9]" id="trust">
          <div className="mx-auto max-w-6xl px-6 py-16">
            <div className="flex flex-col justify-between gap-5 md:flex-row md:items-end"><div><p className="text-sm uppercase tracking-widest text-[#5b6470]">The trust layer</p><h2 className="mt-2 max-w-2xl font-maven text-3xl font-semibold tracking-tight">Move fast without stepping into the dark.</h2></div><p className="max-w-sm text-sm leading-relaxed text-[#5b6470]">Built for real people, real money, and the messy middle between a great match and a completed job.</p></div>
